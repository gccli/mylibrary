...
void rtt_init(struct rtlrtt *ptr)
{
	struct timeval	tv;
...
void
rtt_newpack(struct rtlrtt *ptr)
{
	ptr->rtt_nrexmt = 0;
}

int
rtt_start(struct rtlrtt *ptr)
{
...
/* include rtt_stop */
void
rtt_stop(struct rtlrtt *ptr, uint32_t ms)
{
	double		delta;
