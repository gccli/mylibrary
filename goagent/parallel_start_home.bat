...
REM -------- LEFT TOP --------
@START "Goagent" python27.exe proxy.py -p 8087 ilidevelx ilidevelx0 ilidevelx1 ilidevelx2
nircmdc.exe wait %_WAITTIME_%
nircmdc.exe win setsize foreground %_WINLEFTX_% %_WINLEFTY_% %_WINLEFTW_% %_WINLEFTH_%

@START "Goagent" python27.exe proxy.py -p 8088 -n ilidevelx0 ilidevelx1 ilidevelx2
...
@START "Goagent" python27.exe proxy.py -p 8089 -n ilidevelx1 ilidevelx2 ilidevelx0
nircmd.exe wait %_WAITTIME_%
nircmdc.exe win setsize foreground %_WINLEFTX_% %_WINLEFTY_% %_WINLEFTW_% %_WINLEFTH_%

@START "Goagent" python27.exe proxy.py -p 8090 -n ilidevelx2 ilidevelx0 ilidevelx1
nircmd.exe wait %_WAITTIME_%
nircmd.exe win setsize foreground %_WINRIGHTX_% %_WINRIGHTY_% %_WINRIGHTW_% %_WINRIGHTH_%
